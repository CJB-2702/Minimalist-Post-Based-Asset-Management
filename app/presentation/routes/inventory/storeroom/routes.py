...
def register_storeroom_routes(bp: Blueprint):
    """Register storeroom designer routes with the inventory blueprint"""
    
    @bp.route('/storeroom/index')
    @login_required
    def storeroom_index():
    ...
    @bp.route('/storeroom/create', methods=['GET', 'POST'])
    @login_required
    ...
    @bp.route('/storeroom/<int:storeroom_id>/view-raw-svg')
    @login_required
    ...
    @bp.route('/storeroom/<int:storeroom_id>/view')
    @login_required
    def storeroom_view(storeroom_id):
        """View storeroom summary (read-only)"""
        storeroom_context = StoreroomContext(storeroom_id)
        
        # Get all locations with their bins
        location_contexts = storeroom_context.locations
        locations = [loc_ctx.location for loc_ctx in location_contexts]
    ...
    @bp.route('/storeroom/<int:storeroom_id>/edit', methods=['GET', 'POST'])
    @login_required
    ...
    @bp.route('/storeroom/<int:storeroom_id>/delete', methods=['POST'])
    @login_required
    ...
    @bp.route('/storeroom/<int:storeroom_id>/add-location', methods=['POST'])
    @login_required
    ...
    @bp.route('/storeroom/<int:storeroom_id>/upload-layout', methods=['POST'])
    @login_required
    ...
    @bp.route('/storeroom/location/<int:location_id>/delete', methods=['POST'])
    @login_required
    ...
    @bp.route('/storeroom/location/<int:location_id>/add-bin', methods=['POST'])
    @login_required
    ...
    @bp.route('/storeroom/location/<int:location_id>/upload-bin-layout', methods=['POST'])
    @login_required
    ...
    @bp.route('/storeroom/location/bin/<int:bin_id>/delete', methods=['POST'])
    @login_required
