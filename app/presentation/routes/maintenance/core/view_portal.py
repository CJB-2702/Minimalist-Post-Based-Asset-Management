"""
Maintenance event view portal routes
"""
...
# Create blueprint for maintenance event view portal
maintenance_event_bp = Blueprint('maintenance_event_view', __name__, url_prefix='/maintenance/maintenance-event')
