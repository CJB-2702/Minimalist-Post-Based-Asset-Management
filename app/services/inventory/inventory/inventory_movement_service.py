...
class InventoryMovementService:
    ...
    def get_list_data(
        ...
        Args:
            ...
            location_id: Filter by major location
            storeroom_id: Filter by storeroom
            movement_type: Filter by movement type (Receipt, Issue, Adjustment, BinTransfer, Relocation, Return)
        ...
        form_options = {
            'movement_types': ['Receipt', 'Issue', 'Adjustment', 'BinTransfer', 'Relocation', 'Return'],
